package fernando.ramirez.ticketit.ui.home
...
import fernando.ramirez.ticketit.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val btnCrearTicket = binding.btnCrearTicket
        val estados = listOf("Activo", "Finalizado")
        val adapter = ArrayAdapter(requireContext(), layout.simple_spinner_item, estados)
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        spinEstado.adapter = adapter
        binding.btnCrearTicket.setOnClickListener {
